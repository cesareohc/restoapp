...
if($result > 0):
	...
	if(($result->is_subdomain==1 || $result->is_domain==1) && $result->status==2 && $result->is_ready==1):
		...
		$route['specialties'] = 'profile/specialties';
		$route['specialities'] = 'profile/specialties';
...
$route['specialties/(:any)'] = 'profile/specialties/$1';
$route['contacts/(:any)'] = 'profile/contacts/$1';
...
//new
$route['shop-reviews'] = 'profile/review/$1';
$route['pagadito-success'] = 'user_payment/pagadito_success';
