...
<head>
	...
	<!-- custom css -->
	<link rel="stylesheet" href="<?= base_url(); ?>assets/frontend/css/frontend.css?v=<?= $settings['version'];?>">
	<link rel="stylesheet" href="<?= base_url(); ?>assets/frontend/css/style.css?v=<?= $settings['version'];?>">
	<!-- custom css -->
	<!-- custom css -->
...
<?php endif;?>
	...
	<!-- responsive css -->
	<link rel="stylesheet" href="<?= base_url(); ?>assets/frontend/css/responsive.css?v=<?= $settings['version'];?>&t=<?= time();?>">
	<!-- responsive css-->
    ...
    <script src="<?= base_url();?>assets/frontend/js/auth.js?v=<?= $settings['version'];?>&t=<?= time();?>" ></script>
	<!-- ==========
   		End Default Js
    =============== -->
    <body>
