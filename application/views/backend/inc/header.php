...
<head>
  ...
  <!-- chosen animation -->
  <link rel="stylesheet" href="<?= base_url()?>assets/admin/plugins/chosen/chosen.css">
  ...
  <link rel="stylesheet" href="<?= base_url()?>assets/admin/default.php?v=<?= $settings['version'];?>&time=<?= time();?>">

  <link rel="stylesheet" href="<?= base_url()?>assets/admin/style.main.css?v=<?= $settings['version'];?>&time=<?= time();?>">
  <?php if(direction()=='rtl'): ?>
  ...
  <?php if(file_exists(APPPATH.'controllers/admin/Pos.php')): ?>
    <link rel="stylesheet" href="<?= base_url()?>assets/admin/pos.css?v=<?= $settings['version'];?>&time=<?= time();?>">
  <?php endif;?>
  
  <link rel="stylesheet" href="<?= base_url()?>assets/admin/default.css?v=<?= $settings['version'];?>&time=<?= time();?>">
   <?php if(direction()=='rtl'): ?>
    <link rel="stylesheet" href="<?= base_url()?>assets/admin/admin_rtl.css">
  <?php endif ?>
