...
<div class="payment_content text-center">
	...
	<?php if(is_demo()==0): ?>
		<a href="<?php echo base_url('stripe-payment/'.html_escape($u_info['username']).'/'.html_escape($package['slug'])); ?>" class="btn btn-success pay_now"><?= !empty(lang('pay_now'))?lang('pay_now'):"Pay Now"?> &nbsp;( <?= get_currency('icon');?> <?= isset($package['price'])?html_escape($package['price']):'';?> )</a>
	<?php endif;?>
