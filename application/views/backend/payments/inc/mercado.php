...
<div class="payment_content text-center <?= is_package;?>">
	...
	<?php if(is_demo()==0): ?>
		<a href="<?= prep_url($init); ?>" class="btn btn-success buy_now"><?= !empty(lang('pay_now'))?lang('pay_now'):"Pay Now"?> &nbsp;( <?= get_currency('icon');?> <?= isset($package['price'])?html_escape($package['price']):'';?> )</a>
	<?php endif;?>
</div><!-- payment_content -->
<?php else: ?>
