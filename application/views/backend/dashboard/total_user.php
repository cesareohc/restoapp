				...
				<div class="table-responsive">
	                ...
	                <?php $i=1; foreach ($all_user as $key => $row): ?>
		                <tr>
		                  ...
		                  <td>
		                  		<a href="javascript:;" data-toggle="tooltip" title="<?= lang('supervised_by');?>"  class="label <?= $row['staff_id']==0?"bg-success-soft":"bg-light-purple-soft";?> "><?= $row['staff_id']==0?lang('admin'):s_id($row['staff_id'],'staff_list')->name;?></a>
