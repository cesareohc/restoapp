								...
								<?php $i=1; foreach ($dboy_list as $row): ?>
									<tr>
										...
										<td>
											...
											<a href="<?= base_url('delete-single-item/'.$row['id'].'/staff_list'); ?>" class=" action_btn btn btn-danger btn-sm" data-msg="<?= !empty(lang('want_to_delete'))?lang('want_to_delete'):"want to delete";?>"><i class="fa fa-trash"></i> <?= !empty(lang('delete'))?lang('delete'):"Delete";?></a>
