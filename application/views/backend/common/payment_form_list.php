						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="form-group">
									...
									<div class="">
										<textarea name="offline_details" id="offline_details" class="form-control" cols="5" rows="5" placeholder="<?= lang('bank_details');?>"><?= !empty($offile->offline_details)?html_escape($offile->offline_details):'';  ?></textarea>
									</div>
									<div class="row mt-20">
										<div class="col-md-6">
