		...
		<div class="card-body">
			<div class="leftSidebar">
				<ul class="flex-column">
					...
					<?php endif;?>
					<li><a href="<?= base_url('admin/settings/notification') ?>" class="<?= isset($page_title) && $page_title == "Notification"?"active":"" ;?>"><i class="icofont-hand-drag1"></i> <?= lang('onsignal_api');?></a> </li>
				</ul>
			</div>
		</div>
	</div>
