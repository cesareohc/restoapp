      ...
      <div class="itemModalBody">
          ...
          <div class="item_extra_details">
              ...
              <p class="capital allergen pt-5">
                <?php if(isset($item[0]['allergen']) || isJson($item[0]['allergen'])): ?>
                  <span><b><?= !empty(lang('allergens'))?lang('allergens'):'allregens' ;?></b>: <?= is_array(json_decode($item[0]['allergen_id']))?allergens(json_decode($item[0]['allergen_id'])):$item[0]['allergen'];?> </span>
                <?php endif;?>
              </p>
