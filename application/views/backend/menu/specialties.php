				...
				<div class="box-body">
					...
					<div class="row">
						<div class="form-group col-md-6">
					      	<label for="price"><?= !empty(lang('price'))?lang('price'):"Price";?> *&nbsp; &nbsp;
					      	 	<label data-toggle="tooltip" data-placement="top" title="If you set discount" class="pointer p-5 label label-info discount_label label_input"><input type="checkbox" name="is_discount" class="is_discount" value="1" <?= isset($data['is_discount']) && $data['is_discount']==1?'checked':''; ;?>> &nbsp; Is Discount</label> 
					      	</label>
					...
					<div class="row">
					    ...
					    <div class=" form-group col-md-12">
							...
							<textarea name="overview" id="" cols="5" rows="5" class="form-control" placeholder=" <?= !empty(lang('short_description'))?lang('short_description'):"Short Description";?>"><?= !empty($data['overview'])?html_escape($data['overview']):set_value('overview'); ?></textarea>
						</div>
