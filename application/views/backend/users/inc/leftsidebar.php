		...
		<div class="card-body">
			<div class="leftSidebar">
				<ul class="flex-column">
					...
					<li><a href="<?= base_url('admin/auth/order_type_config'); ?>" class="<?= isset($page_title) && $page_title == "Order Types Configuration"?"active":"" ;?>"> <i class="icofont-navigation-menu"></i> <?= !empty(lang('order_types_config'))?lang('order_types_config'):"Order Types Configuration"; ?></a></li>
					 ...
					 <?php if(is_feature(auth('id'),'online-payment')==1): ?>
						<?php if(check()==1 && $this->security->online_payment()==1): ?>
							<li><a href="<?= base_url(isset($this->link['payment_link'])?$this->link['payment_link']:''); ?>" class="<?= isset($page_title) && $page_title == "Payment Configuration"?"active":"" ;?> <?= is_package;?> paymentMethod"> <i class="icofont-pay"></i> <?= !empty(lang('payment_configuration'))?lang('payment_configuration'):"Payment Configuration"; ?></a></li>
					...
					<?php if(restaurant()->is_area_delivery==1): ?>
					...
					<li><a href="<?= base_url('admin/auth/extras'); ?>" class="<?= isset($page_title) && $page_title == "Extras"?"active":"" ;?>" ><i class="icofont-ui-next"></i> <?= !empty(lang('extras'))?lang('extras'):"Extras";?> </a> <?= is_new('3.1.0');?></li>
