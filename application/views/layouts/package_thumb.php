<div class="homeSingle_packages">
	...
	<div class="singleItemDetails homePackages">
		...
		<div class="p-0">
			<p>
				<?php if(!empty($item['allergen_id']) || !empty($item['allergen'])): ?>
				<span class="capital fz-13"><?= !empty(lang('allergens'))?lang('allergens'):'allregens' ;?>: <?= is_array(json_decode($item['allergen_id']))?allergens(json_decode($item['allergen_id'])):$item['allergen'];?></span>
			<?php endif;?>
			</p>
		</div>
	</div>
