			...
			<div class="col-md-9">
				<div class="serviceRightSide">
					<div class="profleForm">
						...
						<form action="<?= base_url('staff/update_profile') ;?>" method="post" enctype= "multipart/form-data">
							...
							<div class="row">
								...
								<div class="form-group col-md-6">
									...
									<select name="question" id="" class="form-control">
										<?php foreach ($question_list as $q): ?>
											<option value="<?= $q['id'];?>" <?= isset($question->id) && $question->id==$q['id']?"selected":"";?>> <?= $q['title'];?></option>
										<?php endforeach ?>
									</select>
								</div>
								...
								<div class="form-group col-md-6">
									...
									<input type="text" name="answer" id="" class="form-control" placeholder="<?= lang('write_your_answer_here');?>" value="<?= isset($question->answer) && !empty($question->answer)? $question->answer:"";?>">
								</div>
								...
								<div class="form-group col-md-12">
									...
									<div class="input-group">
										...
										<input type="text" name="gmap_link" class="form-control"  placeholder="<?= !empty(lang('gmap_link'))?lang('gmap_link'):"gmap_link";?>" value="<?=  $info['gmap_link'];?>">
									</div>
								...
								<div class="form-group col-md-12">
									...
									<textarea name="address" id="" cols="5" rows="5" class="form-control"><?=  $info['address'];?></textarea>
