<html>
    ...
    <body style="min-height: 100vh;background: #fff;">
        <div style="max-width: 79mm; margin: 0px auto;">
            <div class="info">
            ...
            <table class="change mt-3" style="font-size: 10px;">
                <thead>
                    <tr style="background: rgb(238, 238, 238);">
                        <th colspan="1" style="text-align: left;"><?= lang('payment_by'); ?>:</th>
                        <th colspan="2" style="text-align: center;"><?= lang('amount'); ?>:</th>
                        <th colspan="1" style="text-align: right;"><?= lang('status'); ?>:</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td colspan="2" style="text-align: center;"><?= currency_position($grand_total,restaurant($id)->id);?></td>
            ...
            <div id="legalcopy" class="ml-2">
                <p class="legal"><strong><?= !empty(lang('thank_you_purchase_msg'))?lang('thank_you_purchase_msg'):"Thank you for shopping with us . Please come again" ;?></strong></p>
