				...
				<div class="col-sm-4" data-aos="fade-up" data-aos-delay="<?= $key+1;?>00">
					<div class="single_users">
						...
						<div class="single_user_body">
							...
							<a href="<?php echo base_url(html_escape($row['username'])); ?>" target="blank" class="profile_btn"><i class="fa fa-eye"></i> <?= !empty(lang('view_profile'))?lang('view_profile'):"View Profile";?></a>
						</div>
					</div>
				</div>
			<?php endforeach ?>
