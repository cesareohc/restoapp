...
<head>
	...
	<?php if(isset($slug) && isset($id)): ?>
		...
		<?php $seo =  !empty($user_settings['seo_settings'])?json_decode($user_settings['seo_settings'],true):'';?>
	...
	<?php else: ?>
		<?php $seo =  json_decode($settings['seo_settings'],true);?>
		<meta property="og:type"          content="article" />
	    <meta property="og:title"         content="<?= isset($seo['title'])?html_escape($seo['title']):'';?>" />
	    <meta property="og:description"   content="<?= isset($seo['description'])?html_escape($seo['description']):'';?>" />
	    <meta property="og:url"           content="<?= base_url();?>" />
	...
	<?php if(direction()=='rtl'): ?>
	    ...
	    <link rel="stylesheet" href="<?= base_url()?>assets/frontend/css/custom_rtl.css?v=<?= $settings['version'];?>&time=<?= time();?>">
	  <?php endif ?>
	<!-- Bootstrap CSS -->
  ...
  <link rel="stylesheet" href="<?= base_url()?>assets/frontend/plugins/sweetalert/sweet-alert.css">
	...
	<link rel="stylesheet" href="<?= base_url(); ?>assets/frontend/css/frontend.css?v=<?= $settings['version'];?>&time=<?= time();?>">
	<link rel="stylesheet" href="<?= base_url(); ?>assets/frontend/css/style.css?v=<?= $settings['version'];?>&time=<?= time();?>">
	<!-- custom css -->
...
<!-- custom css -->
	...
	<!-- custom css -->
		<link rel="stylesheet" href="<?= base_url(); ?>assets/frontend/css/default.php?themes=<?= $u_info['theme'];?>&theme_color=<?= $u_info['theme_color'] ;?>&color=<?= $u_info['colors'];?>">
	<?php endif;?>
...
<?php if(isset($settings['system_fonts']) && !empty($settings['system_fonts'])): ?>
	...
	<link rel="stylesheet" href="<?= base_url(); ?>assets/frontend/css/fonts.php?name=<?= $settings['system_fonts'] ;?>">
<?php endif;?>

	<!-- responsive css -->
	<link rel="stylesheet" href="<?= base_url(); ?>assets/frontend/css/responsive.css?v=<?= $settings['version'];?>&time=<?= time();?>">
	<!-- responsive css-->
