          	...
          	<div class="row sm_row_reverse">
          				...
          				<?php foreach ($reviews as $key => $row): ?>
	          				<div class="rating_content">
	          					<div class="rating_header">
	          						...
	          						<div class="rating_by">
	          							<a href="javascript:;"><?= !empty($row['customer_name'])?$row['customer_name']:html_escape($row['customer_name']);?> </a><span class="time_ago"><i class="fa fa-clock"></i> <?= get_time_ago($row['rating_time']);?></span>
	          						</div>
	          					</div>
          		...
          		<div class="col-md-4">
          			<div class="author_rating">
          				<?php $avg = number_format($total_rating/$total_review,1); ?>
