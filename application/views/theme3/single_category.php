<section class="sectionDefault categorySection">
    ...
    <div class="container restaurant-container style_2 theme_3">
      <div class="row">
        <div class="col-md-12">
              ...
              <button type="button" class="btn btn-default cat__btn dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu">
                  ...
                  <?php foreach ($cat_list as $key => $cat): ?>
                    <?php if(md5($cat['id'])!=$cat_id): ?>
                      <a class="dropdown-item" href="<?= base_url("item-types/{$slug}/".md5($cat['id'])) ;?>"><?= $cat['name'] ;?></a>
                    <?php endif;?>
                  <?php endforeach ?>
              </div>
            </div>
      ...
      <?php if(isset($cat_info['details']) && !empty($cat_info['details'])): ?>
      <div class="row">
        <div class="col-md-12">
          <div class="catDetails">
            <?php if(!empty($cat_info['thumb'])): ?>
              <img src="<?= base_url($cat_info['thumb']); ?>" alt="">
            <?php endif;?>
            <div class="itemdetails">
              <p><?= $cat_info['details'] ;?></p>
            </div>
          </div>
        </div>
      </div>
