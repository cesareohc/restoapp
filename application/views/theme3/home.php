...
<section class="sectionDefault theme_3 style_2 pb-0">
...
<section class="Searcharea">
  ...
  <div class="container restaurant-container style_2">
    <div class="row">
      <div class="col-md-12">
        <div id="showCatItem">
          ...
          <div class="row mt-30">
           <div class="col-md-12">
             <div class="text-center seeMore_btn">
               <a href="<?= base_url('specialties/'.$slug) ;?>" class="btn custom-btn seemomre"><?= lang('see_more'); ?></a>
             </div>
           </div>
         </div>
       <?php endif; ?>
